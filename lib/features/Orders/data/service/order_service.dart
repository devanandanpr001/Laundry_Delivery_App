...
//     DioClient dioClient, String endpoint, OrderType orderType, {bool forceCompleted = false}) async {
...
//       return OrderModel.fromJson(rawJson, orderType, forceCompleted: forceCompleted);
//     }).toList();
//   }
//   return [];
// }
...
//       _fetchAndParseOrders(_dioClient, ApiConstants.pickupAssignedOrders, OrderType.pickup);
...
//       _fetchAndParseOrders(_dioClient, ApiConstants.deliveryAssignedOrders, OrderType.delivery);
...
//           // Determine order type from the 'roleType' field in the response
//           final String roleType = parsedJson['roleType'] ?? '';
//           final OrderType orderType = roleType.toLowerCase().contains('delivery') 
//                                       ? OrderType.delivery 
//                                       : OrderType.pickup;
//           return OrderModel.fromJson(parsedJson, orderType);
//         }).toList();
//       } else {
//         // If the API call is not successful or data is not a list, return an empty list.
//         debugPrint("fetchAllOrders did not return success or data was not a list.");
//         return [];
//       }
//     } catch (e) {
