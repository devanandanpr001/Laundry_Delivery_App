...
// import 'package:ziya_laundry_deliveryapp/features/Orders/viewmodel/DeliveryStage.dart'; // Keep this import for now, but consider moving DeliveryStage enum
...
//   factory OrderModel.fromJson(Map<String, dynamic> json, OrderType type, {bool forceCompleted = false}) {
...
//       status: forceCompleted ? OrderStatus.completed : parseOrderStatus(json['status'] ?? details?['status'], finalType), 
//       orderType: finalType, 
...
//               // Prevent prepending server URL to local device paths
//               bool isLocal = path.startsWith('/data/') || path.startsWith('/storage/') || path.startsWith('file:');
              
//               if (path.isNotEmpty && !path.startsWith('http') && !isLocal) {
