...
//                       backgroundColor: isVerified ? AppColors.green : AppColors.primaryBlue, // Green if verified
//                       elevation: 0,
//                       shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8.r)),
//                       padding: EdgeInsets.all(8.w),
//                     ),
...
//           ),
//         ),
//         // Report Item Mismatch section, only shown if not verified
//         if (!isVerified)
//           Container(
                ...
                ConstrainedBox(
                  ...
                  child: SingleChildScrollView(
                    child: BundleSection(
                      bundles: currentOrder.bundles,
                      onAddTap: currentOrder.isVerified ? () {} : () => _openBundleDialog(context),
                      onDelete: currentOrder.isVerified ? (i) {} : (i) async {
